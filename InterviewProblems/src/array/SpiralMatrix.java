...
public class SpiralMatrix {
    /*
     * use positions of four sides: top, bottom, left, right to greatly simplify
     * coding complexity
     * 
     * Do not forget to handle special cases when the matrix has only one row or one column
     */
	...
	public ArrayList<Integer> spiralOrder(int[][] matrix, int offset) {
	    ArrayList<Integer> result = new ArrayList<Integer>();
