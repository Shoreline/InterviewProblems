...
public class TwoSum {
     ...
     */
    /*
     * The tricky part is that this problem requires to return the indice, not
     * just the values
     * 
	...
	/*
	 * Do not forget that now i, j is the index of sorted array temp. What
	 * we need to output is the indice of the original array
	 */
