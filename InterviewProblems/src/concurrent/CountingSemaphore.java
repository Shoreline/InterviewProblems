...
// java.lang.Object.notify(): Wakes up a single thread that is waiting on this
// object's monitor
public class CountingSemaphore {
    private int permits = 0;

    public CountingSemaphore(int _permits) {
	permits = _permits;
    }
	...
	if (permits > 0)
	    this.notifyAll(); // this.notify()? - It may cause issues. If not sure, use notifyAll()
    }
